...
function reportScrapeStart(url, articleCount) {
  ...
  console.log(
    `  ${c("cyan", "Checking:")} First ${articleCount} articles on /newest\n`,
  );
  divider();
}
